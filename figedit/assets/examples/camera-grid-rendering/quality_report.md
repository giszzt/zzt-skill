...
- Project: camera-grid-rendering-editable
- Source image: `source.png`
- Canvas: 1832 x 1523
- OCR status: ok (80 text candidates)
- OpenCV status: ok ({'lines': 1574, 'rectangles': 1, 'arrowheads': 0, 'dashed_groups': 100})
- Assets: 25
- Elements: 212
- SVG text elements: 55
- SVG math elements: 15
- Formula-like text leaks: 0
- PPTX editable formula objects: 15/15
- Structural SVG elements: 117
...
- editability: `ok` text_lift_ratio=0.871 asset_text_risks=0
